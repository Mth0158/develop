...
`sentry/features/__init__.py`](https://github.com/getsentry/sentry/blob/master/src/sentry/features/__init__.py). They're declared on the `FeatureManager` like so:
